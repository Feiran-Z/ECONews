...
tools: mcp__exa__web_search_exa, mcp__exa__get_code_context_exa, Bash, Glob, Grep, Read, Edit, Write, NotebookEdit, Skill, TaskCreate, TaskGet, TaskUpdate, TaskList
model: sonnet
---
